...
![](https://img.shields.io/github/stars/Vietnamvpn/XrayR)
![](https://img.shields.io/github/forks/Vietnamvpn/XrayR)
![](https://github.com/Vietnamvpn/XrayR/actions/workflows/release.yml/badge.svg)
![](https://github.com/Vietnamvpn/XrayR/actions/workflows/docker.yml/badge.svg)
[![Github All Releases](https://img.shields.io/github/downloads/Vietnamvpn/XrayR/total.svg)]()

[Iranian(farsi) README](https://github.com/Vietnamvpn/XrayR/blob/master/README_Fa.md), [Vietnamese(vi) README](https://github.com/Vietnamvpn/XrayR/blob/master/README-vi.md), [English(en) README](https://github.com/Vietnamvpn/XrayR/blob/master/README-en.md)
...
## Tài liệu
Sử dụng hướng dẫn: [Hướng dẫn chi tiết](https://Vietnamvpn.github.io/XrayR-doc/) ( Tiếng Trung )
...
```
wget -N https://raw.githubusercontent.com/Vietnamvpn/XrayR-release/master/install.sh && bash install.sh
```

### Sử dụng phần mềm triển khai Docker

[Hướng dẫn cài đặt thông qua Docker](https://Vietnamvpn.github.io/XrayR-doc/xrayr-xia-zai-he-an-zhuang/install/docker)

### Hướng dẫn cài đặt

[Hướng dẫn cài đặt thủ công](https://Vietnamvpn.github.io/XrayR-doc/xrayr-xia-zai-he-an-zhuang/install/manual)

## Tệp cấu hình và hướng dẫn sử dụng chi tiết

[Hướng dẫn chi tiết](https://Vietnamvpn.github.io/XrayR-doc/)
...
[Mozilla Public License Version 2.0](https://github.com/Vietnamvpn/XrayR/blob/master/LICENSE)
...
[![Stargazers over time](https://starchart.cc/Vietnamvpn/XrayR.svg)](https://starchart.cc/Vietnamvpn/XrayR)
